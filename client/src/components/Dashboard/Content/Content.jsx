    ...
    try{
      const chainId = Moralis.chainId;
        if (chainId !== '0x507') {
                  ...
                  try {
                    await Moralis.switchNetwork("0x507")
                                                    ...
                                                    <Box w="100%" d="flex" pt={0.5}>
                                                        ...
                                                        <Box w="10%">
                                                          <Tooltip label='Contract'>
                                                            <ChakraLink isExternal href={`https://moonbase.moonscan.io/${nft?.contract}`}>
                                                        ...
                                                        <Center>
                                                            ...
                                                            <Box pl={5}>
                                                              <Tooltip label='View on explorer'>
                                                                <ChakraLink isExternal href={`https://moonbase.moonscan.io/${video?.contract}?a=${video?.owners?.filter(data => data.userId === user)[0].tokenId}`}>
